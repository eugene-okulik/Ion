...
def my_post():
    body = {"data": {"color": "blue", "size": "medium"}, "id": 100, "name": "My object"}
...
def put_my_post():
    ...
    response = requests.put(
        f"http://167.172.172.115:52353/object/{post_id}", json=body, headers=headers
    )
...
def patch_my_post():
    body = {"data": {"color": "pink", "size": "very small"}, "name": "My update object"}
    headers = {"Content-Type": "application/json"}
